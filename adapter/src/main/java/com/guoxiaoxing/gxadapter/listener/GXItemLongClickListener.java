 ...
 */
public abstract class GXItemLongClickListener extends GXClickListener {
    ...
    public abstract void SimpleOnItemLongClick(GXAdapter adapter, View view, int position);
}

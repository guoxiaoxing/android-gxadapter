...
public class SectionData {
    ...
    StickyLayoutManager.LayoutParams headerParams;

    public SectionData(StickyLayoutManager lm, View first) {
        final int paddingStart = lm.getPaddingStart();
        final int paddingEnd = lm.getPaddingEnd();

        headerParams = (StickyLayoutManager.LayoutParams) first.getLayoutParams();
    ...
    public boolean sameSectionManager(StickyLayoutManager.LayoutParams params) {

...
public class FCSwipeLayout extends FrameLayout {
    ...
    public FCSwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FCAdapter_SwipeLayout);
        int dragEdgeChoices = a.getInt(R.styleable.FCAdapter_SwipeLayout_fcadapter_drag_edge, DRAG_RIGHT);
        mEdgeSwipesOffset[DragEdge.Left.ordinal()] = a.getDimension(R.styleable.FCAdapter_SwipeLayout_fcadapter_leftEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Right.ordinal()] = a.getDimension(R.styleable.FCAdapter_SwipeLayout_fcadapter_rightEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Top.ordinal()] = a.getDimension(R.styleable.FCAdapter_SwipeLayout_fcadapter_topEdgeSwipeOffset, 0);
        mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] = a.getDimension(R.styleable.FCAdapter_SwipeLayout_fcadapter_bottomEdgeSwipeOffset, 0);
        setClickToClose(a.getBoolean(R.styleable.FCAdapter_SwipeLayout_fcadapter_clickToClose, mClickToClose));
        ...
        int ordinal = a.getInt(R.styleable.FCAdapter_SwipeLayout_fcadapter_show_mode, ShowMode.PullOut.ordinal());
     ...
     * {@link com.souche.android.sdk.fcadapter.swipe.FCSwipeLayout.OnRevealListener}
     *
     ...
     * @param l        the {@link com.souche.android.sdk.fcadapter.swipe.FCSwipeLayout.OnRevealListener}
     */
     ...
     * {@link com.souche.android.sdk.fcadapter.swipe.FCSwipeLayout.ShowMode}.PullOut and
     * {@link com.souche.android.sdk.fcadapter.swipe.FCSwipeLayout.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link com.souche.android.sdk.fcadapter.swipe.FCSwipeLayout.Status} Open , Close or
     * Middle.
     */

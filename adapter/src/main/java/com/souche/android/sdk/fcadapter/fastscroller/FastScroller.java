package com.souche.android.sdk.fcadapter.fastscroller;
...
/**
 * Class taken from GitHub, customized and optimized for FCAdapter project.
 *
 * @author guoxiaoxing
...
public class FastScroller extends FrameLayout {
    ...
    public void setRecyclerView(final RecyclerView recyclerView) {
        ...
        if (recyclerView.getAdapter() instanceof onCreateBubbleTextListener)
            this.mOnCreateBubbleTextListener = (onCreateBubbleTextListener) recyclerView.getAdapter();
     ...
     * @param bubbleResId Drawable resource for Bubble containing the Text
     * @param handleResId Drawable resource for the Handle
     * @param bubbleColor Color for Selected state during touch and scrolling (usually accent color)
     */
    public void setViewsToUse(@LayoutRes int layoutResId, @IdRes int bubbleResId, @IdRes int handleResId, int bubbleColor) {
        setViewsToUse(layoutResId, bubbleResId, handleResId);
        setBubbleAndHandleColor(bubbleColor);
    }
    ...
    private void setBubbleAndHandleColor(int accentColor) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            bubbleDrawable = (GradientDrawable) getResources().getDrawable(R.drawable.baselib_fast_scroller_bubble, null);
        } else {
            //noinspection deprecation
            bubbleDrawable = (GradientDrawable) getResources().getDrawable(R.drawable.baselib_fast_scroller_bubble);
        }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                stateListDrawable = (StateListDrawable) getResources().getDrawable(R.drawable.baselib_fast_scroller_handle, null);
            } else {
                //noinspection deprecation
                stateListDrawable = (StateListDrawable) getResources().getDrawable(R.drawable.baselib_fast_scroller_handle);
            }
    ...
    private void setRecyclerViewPosition(float y) {
        if (recyclerView != null) {
            ...
            //Scroll To Position based on StickyLayoutManager
            ...
            //Update bubbleText
            if (bubble != null) {
                String bubbleText = mOnCreateBubbleTextListener.onCreateBubbleText(targetPos);
                if (bubbleText != null) {
    ...
    public interface onCreateBubbleTextListener {

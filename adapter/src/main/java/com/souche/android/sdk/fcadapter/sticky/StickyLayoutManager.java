...
/**
 * A StickyLayoutManager that lays out mSection headers with optional stickiness and uses a map of
 * sections to view layout managers to layout items.
 * <p>
 * For more information, you can contact me by guoxiaoxing@souche.com
 *
 * @author guoxiaoxing
 * @since 16/9/19 下午5:14
 */
public class StickyLayoutManager extends RecyclerView.LayoutManager {
    ...
    public StickyLayoutManager(Context context) {
        mLinearSlm = new LinearStickyLayoutManager(this);
        mGridSlm = new GridStickyLayoutManager(this, context);
        mSlms = new HashMap<>();
    }

    StickyLayoutManager(Builder builder) {
        mLinearSlm = new LinearStickyLayoutManager(this);
        mGridSlm = new GridStickyLayoutManager(this, builder.context);
        mSlms = builder.slms;
    }
...
//            attachView(header, findLastIndexForSection(sd.firstPosition) + 1);
    ...
    public static class Builder {
        ...
        public StickyLayoutManager build() {
            return new StickyLayoutManager(this);
        }
    }
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        public static LayoutParams from(ViewGroup.LayoutParams other) {
            if (other == null) {
                Log.w("SuperSLiM",
                        "Null value passed in call to StickyLayoutManager.LayoutParams.from().");
                return new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
